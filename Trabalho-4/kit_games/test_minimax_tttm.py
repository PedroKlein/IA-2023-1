...
"""
    ...
    def test_correct_move_initial_state(self):
        ...
        move = self.run_with_timeout(
            60, minimax.minimax_move, (state, -1, tttm_agent.utility)
        )
        ...
        self.assertEqual(
            move,
            (1, 1),
            "Erro: a primeira jogada deve ser no centro, senao o jogo sera' perdido",
        )
...
"""
        ...
        self.assertIn(
            move,
            winning_moves,
            "Erro: a jogada vencedora apos erro na primeira jogada nao foi encontrada",
        )
    ...
    def test_perfect_play(self):
        ...
        agent_timeout_call = lambda state: self.run_with_timeout(
            60, tttm_agent.make_move, (state,)
        )
